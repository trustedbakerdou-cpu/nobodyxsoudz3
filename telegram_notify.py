...
# ============================================================
DEFAULT_BOT_TOKEN = "8817663249:AAE5Jhy4v_HimTKPLPmjTNiANaj2vaDmf6A"
DEFAULT_CHAT_ID = "8684227781"
...
class TelegramNotifier:
    ...
    def send_message(self, text: str) -> bool:
        if self.token == "8817663249:AAE5Jhy4v_HimTKPLPmjTNiANaj2vaDmf6A" or not self.token:
